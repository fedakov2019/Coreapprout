export function LogoIcon(props:React.SVGProps<SVGAElement>){
  return (
    <svg
  ...
  >
    ...
    <g fill="#3e4347">
      ...
      <path d="M53.1 53.3c-.5.3-1.2.1-1.5-.4c-.3-.5-.1-1.2.4-1.5c.5-.3 1.2-.1 1.5.4s.1 1.2-.4 1.5" />
    </g>
    ...
    <g fill="#3e4347">
      ...
      <path d="M10.9 55.7c.5-.3 1.2-.1 1.5.4c.3.5.1 1.2-.4 1.5c-.5.3-1.2.1-1.5-.4c-.3-.5-.1-1.2.4-1.5" />
